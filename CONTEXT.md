...
- **Master-trait option** — one selectable entry in a style×rank section. Options split into **generic** ones (e.g. *DMG Cap +20%*, *Max HP +15k*) shared by every character, and **character-specific** skill-related ones (e.g. Io's *SG Cap 35%*). The catalog factors them accordingly; the Build just references option ids.
