...
/** Icon / name / level row, ruled off from the next one. */
export function TraitRow({
  ...
  return (
    <div
      className={`border-line-soft grid grid-cols-[16px_1fr_auto] items-center gap-1.75 border-b last:border-b-0 last:pb-0 ${
        compact ? "py-[2.5px] text-[13.5px]" : "py-0.75 text-[14.5px]"
      }`}
    >
      {children}
    </div>
