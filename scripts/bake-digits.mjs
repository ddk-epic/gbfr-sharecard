/**
 * Bakes the level figures into src/components/build/glyphs/digits.generated.ts.
 ...
 *
 * The Lvl diamond is NOT baked here. Its source PNG is not checked in, so it
 * lives hand-kept in glyphs/lvl-diamond.ts; this script must stay able to run
 * without it.
...
const OUT = new URL("../src/components/build/glyphs/digits.generated.ts", import.meta.url);
const QUALITY = 90;
...
const source = `/* Generated by scripts/bake-digits.mjs - do not edit.
   Level figures from the game archive. Metrics are the
...
console.log(
  `wrote digits.generated.ts: ${wanted.length} figures, cell ${cell}, ` +
    `baseline ${baseline}, ${Math.round(source.length / 1024)} KB`,
);
